...
namespace BandedRowsList
{
	...
	public class MainActivity : MauiAppCompatActivity
	{
		protected override void OnCreate(Bundle? savedInstanceState)
		{
			...
			Microsoft.Maui.Controls.Application.Current!.Resources.TryGetValue(GlobalVariables.hdrResourceKey, out object hdrBgColor); Color statusBarColor = (Color)hdrBgColor;
			Microsoft.Maui.Controls.Application.Current!.Resources.TryGetValue(GlobalVariables.ftrResourceKey, out object ftrBgColor); Color navigationBarColor = (Color)ftrBgColor;
